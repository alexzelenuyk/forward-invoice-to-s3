...
> mocha lib/test
  ...
  index
    CLI - functional tests
      ✓ no parameters (106ms)
      ✓ missing file parameter (106ms)
      ✓ validate simple yaml (211ms)
      ✓ validate parameter flag (213ms)
      ✓ validate importValue flag (211ms)
      ✓ validate numeric importValue flag (212ms)
      ✓ validate pseudo flag (211ms)
      ✓ validate pseudo + parameter flag (210ms)
      ✓ invalid pseudo flag throws 2 critical error (210ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (210ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (210ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (213ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (212ms)
      ✓ handle validation exceptions - non-verbose (184ms)
      ✓ handle validation exceptions - verbose (234ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (215ms)
      ✓ parameters of the List<Number> type should accept lists as values (213ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (46ms)
...
{ info: [], warn: [], crit: [] }
    ...
    issues
      ...
      ✓ a template with properties containing nested aggregate types should be validated successfully (79ms)
    ...
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (57ms)
      ✓ should validate using custom resource attribute values for logical-names (55ms)
      ✓ should validate using custom resource attribute values for generic-type and logical-name (57ms)
      ✓ should validate using custom resource attribute values for custom-type and logical-name (58ms)
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (67ms)
    output-references
    ...
    type checking coverage
      ✓ should be able to determine the type of every property of every resource (81ms)
      ✓ should be able to determine the type of every property of every propertytype (153ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (111ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (82ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (422ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (220ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (130ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (279ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (78ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (225ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (174ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (210ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (86ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (145ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (140ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (152ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (139ms)
      ✓ a template missing a required property should fail validation (78ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (236ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (238ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (42ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (41ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (259ms)
