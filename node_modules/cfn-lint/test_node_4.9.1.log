...
> mocha lib/test
  ...
  api
    validateFile
      ✓ should validate a file (93ms)
      ✓ should pass properties (74ms)
      ✓ should pass pseudo-parameters (63ms)
      ✓ should reset validator state (70ms)
    validateJsonObject
      ✓ should validate an object (65ms)
  ...
  index
    CLI - functional tests
      ✓ no parameters (138ms)
      ✓ missing file parameter (134ms)
      ✓ validate simple yaml (306ms)
      ✓ validate parameter flag (315ms)
      ✓ validate importValue flag (312ms)
      ✓ validate numeric importValue flag (314ms)
      ✓ validate pseudo flag (306ms)
      ✓ validate pseudo + parameter flag (310ms)
      ✓ invalid pseudo flag throws 2 critical error (309ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (310ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (309ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (312ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (307ms)
      ✓ handle validation exceptions - non-verbose (231ms)
      ✓ handle validation exceptions - verbose (234ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (306ms)
      ✓ parameters of the List<Number> type should accept lists as values (307ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (112ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using logical-name notation (59ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using mixed notation (46ms)
  ...
  validator
    validateJsonObject
      ✓ a valid (1.json) template should return an object with validTemplate = true, no crit errors (67ms)
      ✓ a valid (2.json) template should return an object with validTemplate = true, no crit errors (67ms)
      ✓ a valid (3.json) template should return an object with validTemplate = true, no crit errors (75ms)
      ✓ a valid (4.json) template should return an object with validTemplate = true, no crit errors (67ms)
      ✓ 2 invalid resource types should return an object with validTemplate = false, 2 crit errors (65ms)
      ✓ 1 missing parameter type should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ 1 invalid parameter type should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ missing section resources should return an object with validTemplate = false, 1 crit errors (60ms)
      ✓ empty section resources should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ 1 invalid resource reference should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ 1 invalid parameter reference should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ 2 invalid Fn::Join's should return an object with validTemplate = false, 2 crit errors (64ms)
      ✓ 1 invalid Fn::GetAtt should return an object with validTemplate = false, 1 crit errors (69ms)
      ✓ 1 invalid Fn::FindInMap should return an object with validTemplate = false, 1 crit errors (65ms)
      ✓ 1 invalid Ref within Parameters should return an object with validTemplate = false, 1 crit errors (65ms)
      ✓ 1 invalid GetAZs parameter should return an object with validTemplate = false, 1 crit errors (70ms)
      ✓ 1 reference non AWS::Region GetAZs parameter should return an object with validTemplate = false, 1 warn errors (67ms)
    Fn::Join
      ✓ should error if it attempts to join anything but a list of values (62ms)
    Fn::Select JSON
      ✓ should pass validation, with flat list and intrinsic list (65ms)
      ✓ should pass validation with Parameter Collection (62ms)
      ✓ should error if index is greater than list size (62ms)
      ✓ should error if second element is not a list or a function (62ms)
      ✓ should error if first element is not a number or does not parse to a number (65ms)
      ✓ should error if first element is not defined or is null (72ms)
      ✓ should error if only one element as argument list (91ms)
      ✓ should error if second element is null or undefined (78ms)
      ✓ should error if second element does not resolve to a list (63ms)
      ✓ should error if first element does not resolve to a number (63ms)
      ✓ should error if first element attempts an invalid intrinsic function (62ms)
      ✓ should error if first element is anything other than non-array object, number or string (65ms)
      ✓ should error if second element attempts an invalid intrinsic function (62ms)
      ✓ should error if second element contains a list with null values (62ms)
    Fn::Select YAML
      ✓ should validate in yaml with literal and intrinic elements in array (62ms)
      ✓ should validate in yaml with Comma Separated List Param (62ms)
      ✓ should error if index is greater than list size (65ms)
      ✓ should error if second element is not a list or a function (62ms)
      ✓ should error if first element is not a number or does not parse to a number (62ms)
      ✓ should error if first element is not defined or is null (63ms)
      ✓ should error if only one element as argument list (64ms)
      ✓ should error if second element is null or undefined (62ms)
      ✓ should error if second element does not resolve to a list (62ms)
      ✓ should error if first element does not resolve to a number (63ms)
      ✓ should error if first element attempts an invalid intrinsic function (65ms)
      ✓ should error if first element is anything other than non-array object, number or string (61ms)
      ✓ should error if second element attempts an invalid intrinsic function (62ms)
      ✓ should error if second element contains a list with null values (62ms)
    Fn::Sub
      ✓ 3 valid Fn::Sub should return an object with validTemplate = true, 0 crit errors (65ms)
      ✓ a sub referencing an invalid resource should result in validTemplate = false, 1 crit errors, no warnings (62ms)
      ✓ a sub getatt an invalid resource should result in validTemplate = false, 2 crit errors, no warnings (62ms)
      ✓ a sub with nested intrinsic values should result in validTemplate = true, 0 crit errors, no warnings (62ms)
    Fn::ImportValue
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (65ms)
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ a valid Fn::ImportValue should return an object with validTemplate = true, 0 crit errors (63ms)
      ✓ an Fn::ImportValue with a correct override should return an object with validTemplate = true, 0 crit errors (63ms)
    Fn::GetAtt
      ✓ Fn::GetAtt for an arbitrary attribute on a custom resource should return a mock result (73ms)
      ✓ should pass validation where !GetAtt returns a list (95ms)
      ✓ should not pass validation where !GetAtt returns a list (81ms)
      ✓ should not pass validation with !GetAtt where attribute does not exist (67ms)
      ✓ should pass validation where !GetAtt returns some unexpected attribute for AWS::CloudFormation::Stack (63ms)
      ✓ should not pass validation with !GetAtt where the resource does not exist (63ms)
    conditions
      ✓ 1 invalid if condition arguments should return an object with validTemplate = false, 1 crit errors (66ms)
      ✓ 1 invalid if condition should return an object with validTemplate = false, 1 crit errors (65ms)
      ✓ 1 invalid condition value should return an object with validTemplate = false, 1 crit errors (64ms)
      ✓ 1 invalid condition value type should return an object with validTemplate = false, 1 crit errors (64ms)
      ✓ 1 valid condition value type should return an object with validTemplate = true, 0 crit errors (71ms)
    Fn::Split
...
{ info: [], warn: [], crit: [] }
    ...
    templateVersion
      ✓ 1 invalid template version should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ 1 missing template version should return an object with validTemplate = true, 0 crit errors (64ms)
    propertyValidation
      ✓ 1 invalid arn property should return an object with validTemplate = false, 1 crit errors (67ms)
      ✓ 1 invalid property name of ResourceType should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ 1 invalid property name of PropertyType should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ 1 invalid property name of Tag list should return an object with validTemplate = false, 1 crit errors (64ms)
      ✓ 1 string property should return an object with validTemplate = false, 1 crit errors (67ms)
      ✓ 1 missing propertyType property should return an object with validTemplate = false, 1 crit errors (66ms)
      ✓ 1 missing resourceType  property should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ 1 missing (via AWS::NoValue) property should return an object with validTemplate = false, 1 crit errors (63ms)
      ✓ 1 invalid boolean property should return an object with validTemplate = false, 1 crit errors (72ms)
      ✓ 4 invalid nested properties should return an object with validTemplate = false, 4 crit errors (67ms)
      ✓ a valid template with a Map property should return an object with validTemplate = true, no crit errors (64ms)
      ✓ an invalid template with a Map property should return an object with validTemplate = false, 1 crit error (66ms)
      ✓ a valid (valid_timestamp.yaml) template with a Timestamp should return an objcet with validTemplate = true (66ms)
      ✓ a (invalid_timestamp.yaml) template with an invalid Timestamp should return an objcet with validTemplate = false, 2 crit errors (64ms)
      ✓ a valid template with APIG string results in validTemplate = true, 0 crit error (72ms)
    validateYamlFile
      ✓ a valid (1.yaml) template should return an object with validTemplate = true, no crit errors (69ms)
      ✓ a valid (2.yaml) template should return an object with validTemplate = true, no crit errors (68ms)
      ✓ a valid (valid_minus_one_as_string.yaml) template should return an object with validTemplate = true, no crit errors (64ms)
    issues
      ✓ a valid ASG template with Tags property should return an object with validTemplate = true, no crit errors (69ms)
      ✓ both methods of defining a custom resource should result in validTemplate = true, no crit errors (63ms)
      ✓ numeric properties should result in validTemplate = true, no crit errors, no warn errors (64ms)
      ✓ IAM with ManagedPolicyName should result in validTemplate=true, no crit errors, no warn errors (66ms)
      ✓ Reference to RDS attribute validTemplate=true, no crit errors, no warn errors (65ms)
      ✓ if condition not working as expected, no crit errors, no warn errors (76ms)
      ✓ if condition not working as expected, 2 crit errors, no warn errors (103ms)
      ✓ a list of an extended parameter type should be properly mocked without causing an exception (64ms)
      ✓ a null property value should not cause an exception (63ms)
      ✓ Fn::Split should support function "Fn::ImportValue" (63ms)
      ✓ a template with properties containing nested aggregate types should be validated successfully (251ms)
      ✓ Issue #214 - SQS Queues now accept Tags (63ms)
    parameters-validation
      ✓ an unallowed parameter value provided at runtime gets rejected (66ms)
      ✓ an allowed parameter value provided at runtime gets allowed (62ms)
      ✓ an empty parameter value provided at runtime picks up the empty default (which will throw an error) (63ms)
      ✓ missing parameters should cause an error when guessParameters is set (62ms)
      ✓ parameters in guessParameters should be permitted to be guessed (65ms)
      ✓ List<AWS::EC2::AvailabilityZone::Name> should return a list (62ms)
      ✓ List<AWS::EC2::Image::Id> should return a list (63ms)
      ✓ List<AWS::EC2::Instance::Id> should return a list (63ms)
      ✓ List<AWS::EC2::SecurityGroup::GroupName> should return a list (66ms)
      ✓ List<AWS::EC2::SecurityGroup::Id> should return a list (63ms)
      ✓ List<AWS::EC2::Subnet::Id> should return a list (62ms)
      ✓ List<AWS::EC2::Volume::Id> should return a list (62ms)
      ✓ List<AWS::EC2::VPC::Id> should return a list (65ms)
      ✓ List<AWS::Route53::HostedZone::Id> should return a list (62ms)
    pseudo-parmeters
      ✓ defining an override for accountId should result in validTemplate = true, no crit errors, no warnings (62ms)
      ✓ using the pseudo parameter AWS::URLSuffix should result in validTemplate = true, no crit errors, no warnings (62ms)
      ✓ using the pseudo parameter AWS::Partition should result in validTemplate = true, no crit errors, no warnings (65ms)
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (170ms)
      ✓ should validate using custom resource attribute values for logical-names (170ms)
      ✓ should validate using custom resource attribute values for generic-type and logical-name (172ms)
      ✓ should validate using custom resource attribute values for custom-type and logical-name (178ms)
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (239ms)
    output-references
      ✓ an output referencing an invalid resource should result in validTemplate = false, 1 crit errors, no warnings (97ms)
      ✓ an output referencing an valid resource should result in validTemplate = true, 0 crit errors, no warnings (65ms)
      ✓ a template with an exported output missing a Name should result in validTemplate = false, 1 crit error (65ms)
    ...
    type checking coverage
      ✓ should be able to determine the type of every property of every resource (63ms)
      ✓ should be able to determine the type of every property of every propertytype (113ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (359ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (269ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (1406ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (731ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (490ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (924ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (256ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (748ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (678ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (693ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (278ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (483ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (468ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (573ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (468ms)
      ✓ a template missing a required property should fail validation (278ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (785ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (787ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (137ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (142ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (910ms)
