...
> mocha lib/test
  ...
  index
    CLI - functional tests
      ✓ no parameters (131ms)
      ✓ missing file parameter (103ms)
      ✓ validate simple yaml (215ms)
      ✓ validate parameter flag (219ms)
      ✓ validate importValue flag (219ms)
      ✓ validate numeric importValue flag (221ms)
      ✓ validate pseudo flag (217ms)
      ✓ validate pseudo + parameter flag (214ms)
      ✓ invalid pseudo flag throws 2 critical error (217ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (256ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (239ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (258ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (213ms)
      ✓ handle validation exceptions - non-verbose (209ms)
      ✓ handle validation exceptions - verbose (259ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (233ms)
      ✓ parameters of the List<Number> type should accept lists as values (231ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (45ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using logical-name notation (38ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using mixed notation (42ms)
  ...
  validator
    validateJsonObject
      ...
      ✓ a valid (3.json) template should return an object with validTemplate = true, no crit errors (38ms)
...
{ info: [], warn: [], crit: [] }
    ...
    issues
      ...
      ✓ a template with properties containing nested aggregate types should be validated successfully (84ms)
    ...
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (62ms)
      ✓ should validate using custom resource attribute values for logical-names (59ms)
      ✓ should validate using custom resource attribute values for generic-type and logical-name (60ms)
      ✓ should validate using custom resource attribute values for custom-type and logical-name (56ms)
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (76ms)
    output-references
    ...
    type checking coverage
      ✓ should be able to determine the type of every property of every resource (91ms)
      ✓ should be able to determine the type of every property of every propertytype (152ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (130ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (87ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (490ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (266ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (153ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (315ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (93ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (277ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (198ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (224ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (92ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (152ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (150ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (164ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (146ms)
      ✓ a template missing a required property should fail validation (85ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (253ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (246ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (43ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (43ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (269ms)
