...
> mocha lib/test
  ...
  api
    validateFile
      ✓ should validate a file (66ms)
      ✓ should pass properties (55ms)
      ✓ should pass pseudo-parameters (47ms)
      ✓ should reset validator state (50ms)
    validateJsonObject
      ✓ should validate an object (38ms)
  ...
  index
    CLI - functional tests
      ✓ no parameters (144ms)
      ✓ missing file parameter (135ms)
      ✓ validate simple yaml (336ms)
      ✓ validate parameter flag (319ms)
      ✓ validate importValue flag (318ms)
      ✓ validate numeric importValue flag (303ms)
      ✓ validate pseudo flag (298ms)
      ✓ validate pseudo + parameter flag (315ms)
      ✓ invalid pseudo flag throws 2 critical error (297ms)
      ✓ guess-parameters should explicitely opt in to parameter mocking (303ms)
      ✓ no-guess-parameters throws errors if we leave out parameters (309ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking (305ms)
      ✓ only-guess-parameters should allow opting in to parameter mocking with multiple params (295ms)
      ✓ handle validation exceptions - non-verbose (233ms)
      ✓ handle validation exceptions - verbose (260ms)
      ✓ parameters of the CommaDelimitedList type should accept lists as values (293ms)
      ✓ parameters of the List<Number> type should accept lists as values (289ms)
    CLI - unit tests
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using resource-type notation (116ms)
      ✓ custom resource attribute parameter should accept an arbitrary attribute value using logical-name notation (50ms)
  ...
  validator
    validateJsonObject
      ✓ a valid (1.json) template should return an object with validTemplate = true, no crit errors (48ms)
      ✓ a valid (2.json) template should return an object with validTemplate = true, no crit errors (46ms)
      ✓ a valid (3.json) template should return an object with validTemplate = true, no crit errors (60ms)
      ✓ a valid (4.json) template should return an object with validTemplate = true, no crit errors (43ms)
      ✓ 2 invalid resource types should return an object with validTemplate = false, 2 crit errors (38ms)
      ✓ 1 missing parameter type should return an object with validTemplate = false, 1 crit errors (38ms)
      ✓ 1 invalid parameter type should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ missing section resources should return an object with validTemplate = false, 1 crit errors (44ms)
      ✓ empty section resources should return an object with validTemplate = false, 1 crit errors
      ✓ 1 invalid resource reference should return an object with validTemplate = false, 1 crit errors (40ms)
      ✓ 1 invalid parameter reference should return an object with validTemplate = false, 1 crit errors (39ms)
      ✓ 2 invalid Fn::Join's should return an object with validTemplate = false, 2 crit errors (39ms)
      ✓ 1 invalid Fn::GetAtt should return an object with validTemplate = false, 1 crit errors (40ms)
      ✓ 1 invalid Fn::FindInMap should return an object with validTemplate = false, 1 crit errors (39ms)
      ✓ 1 invalid Ref within Parameters should return an object with validTemplate = false, 1 crit errors (39ms)
      ✓ 1 invalid GetAZs parameter should return an object with validTemplate = false, 1 crit errors (42ms)
      ✓ 1 reference non AWS::Region GetAZs parameter should return an object with validTemplate = false, 1 warn errors (43ms)
    Fn::Join
    ...
    Fn::Select JSON
      ...
      ✓ should error if first element is not defined or is null (49ms)
      ✓ should error if only one element as argument list (62ms)
      ✓ should error if second element is null or undefined (45ms)
      ✓ should error if second element does not resolve to a list
      ✓ should error if first element does not resolve to a number (39ms)
    ...
    Fn::Select YAML
      ...
      ✓ should error if second element is not a list or a function
      ✓ should error if first element is not a number or does not parse to a number
      ✓ should error if first element is not defined or is null (38ms)
      ...
      ✓ should error if first element attempts an invalid intrinsic function
      ✓ should error if first element is anything other than non-array object, number or string (39ms)
      ✓ should error if second element attempts an invalid intrinsic function
      ✓ should error if second element contains a list with null values (39ms)
    Fn::Sub
      ✓ 3 valid Fn::Sub should return an object with validTemplate = true, 0 crit errors (38ms)
      ✓ a sub referencing an invalid resource should result in validTemplate = false, 1 crit errors, no warnings (38ms)
      ✓ a sub getatt an invalid resource should result in validTemplate = false, 2 crit errors, no warnings (38ms)
      ✓ a sub with nested intrinsic values should result in validTemplate = true, 0 crit errors, no warnings (38ms)
    Fn::ImportValue
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (38ms)
      ✓ 1 invalid Fn::ImportValue should return an object with validTemplate = false, 1 crit errors (38ms)
      ✓ a valid Fn::ImportValue should return an object with validTemplate = true, 0 crit errors (39ms)
      ✓ an Fn::ImportValue with a correct override should return an object with validTemplate = true, 0 crit errors (38ms)
    Fn::GetAtt
      ✓ Fn::GetAtt for an arbitrary attribute on a custom resource should return a mock result (41ms)
      ✓ should pass validation where !GetAtt returns a list (39ms)
      ✓ should not pass validation where !GetAtt returns a list (40ms)
      ✓ should not pass validation with !GetAtt where attribute does not exist (39ms)
    ...
    conditions
      ...
      ✓ 1 invalid if condition should return an object with validTemplate = false, 1 crit errors (38ms)
      ✓ 1 invalid condition value should return an object with validTemplate = false, 1 crit errors (38ms)
      ✓ 1 invalid condition value type should return an object with validTemplate = false, 1 crit errors (39ms)
      ✓ 1 valid condition value type should return an object with validTemplate = true, 0 crit errors (44ms)
    Fn::Split
...
{ info: [], warn: [], crit: [] }
    ...
    templateVersion
      ✓ 1 invalid template version should return an object with validTemplate = false, 1 crit errors (38ms)
      ✓ 1 missing template version should return an object with validTemplate = true, 0 crit errors (38ms)
    propertyValidation
      ✓ 1 invalid arn property should return an object with validTemplate = false, 1 crit errors (39ms)
      ...
      ✓ 1 invalid property name of Tag list should return an object with validTemplate = false, 1 crit errors (38ms)
      ✓ 1 string property should return an object with validTemplate = false, 1 crit errors (38ms)
      ✓ 1 missing propertyType property should return an object with validTemplate = false, 1 crit errors (39ms)
      ✓ 1 missing resourceType  property should return an object with validTemplate = false, 1 crit errors (39ms)
      ✓ 1 missing (via AWS::NoValue) property should return an object with validTemplate = false, 1 crit errors (38ms)
      ✓ 1 invalid boolean property should return an object with validTemplate = false, 1 crit errors (43ms)
      ✓ 4 invalid nested properties should return an object with validTemplate = false, 4 crit errors (42ms)
      ✓ a valid template with a Map property should return an object with validTemplate = true, no crit errors (40ms)
      ✓ an invalid template with a Map property should return an object with validTemplate = false, 1 crit error (39ms)
      ✓ a valid (valid_timestamp.yaml) template with a Timestamp should return an objcet with validTemplate = true (39ms)
      ✓ a (invalid_timestamp.yaml) template with an invalid Timestamp should return an objcet with validTemplate = false, 2 crit errors (39ms)
      ✓ a valid template with APIG string results in validTemplate = true, 0 crit error (41ms)
    validateYamlFile
      ✓ a valid (1.yaml) template should return an object with validTemplate = true, no crit errors (43ms)
      ✓ a valid (2.yaml) template should return an object with validTemplate = true, no crit errors (42ms)
      ✓ a valid (valid_minus_one_as_string.yaml) template should return an object with validTemplate = true, no crit errors
    issues
      ✓ a valid ASG template with Tags property should return an object with validTemplate = true, no crit errors (40ms)
      ✓ both methods of defining a custom resource should result in validTemplate = true, no crit errors
      ✓ numeric properties should result in validTemplate = true, no crit errors, no warn errors (38ms)
      ✓ IAM with ManagedPolicyName should result in validTemplate=true, no crit errors, no warn errors
      ✓ Reference to RDS attribute validTemplate=true, no crit errors, no warn errors (38ms)
      ✓ if condition not working as expected, no crit errors, no warn errors (39ms)
      ✓ if condition not working as expected, 2 crit errors, no warn errors (48ms)
      ✓ a list of an extended parameter type should be properly mocked without causing an exception (62ms)
      ✓ a null property value should not cause an exception (44ms)
      ✓ Fn::Split should support function "Fn::ImportValue"
      ✓ a template with properties containing nested aggregate types should be validated successfully (153ms)
      ✓ Issue #214 - SQS Queues now accept Tags (40ms)
    parameters-validation
      ✓ an unallowed parameter value provided at runtime gets rejected (38ms)
    ...
    pseudo-parmeters
      ✓ defining an override for accountId should result in validTemplate = true, no crit errors, no warnings (38ms)
    ...
    custom-resource-attributes
      ✓ should validate using custom resource attribute values for generic and custom types (97ms)
      ✓ should validate using custom resource attribute values for logical-names (99ms)
      ✓ should validate using custom resource attribute values for generic-type and logical-name (101ms)
      ✓ should validate using custom resource attribute values for custom-type and logical-name (99ms)
      ✓ should validate when a logical-name overrides a resource-type custom attribute value (130ms)
    output-references
      ...
      ✓ a template with an exported output missing a Name should result in validTemplate = false, 1 crit error (38ms)
    ...
    type checking coverage
      ✓ should be able to determine the type of every property of every resource (92ms)
      ✓ should be able to determine the type of every property of every propertytype (213ms)
    ...
    SAM-20161031
      ✓ a sample AWS template (sam_20161031_alexa_skill.yaml) should validate successfully (207ms)
      ✓ a sample AWS template (sam_20161031_all_policy_templates.yaml) should validate successfully (157ms)
      ✓ a sample AWS template (sam_20161031_api_backend.yaml) should validate successfully (787ms)
      ✓ a sample AWS template (sam_20161031_api_swagger_cors.yaml) should validate successfully (417ms)
      ✓ a sample AWS template (sam_20161031_cloudwatch_logs.yaml) should validate successfully (271ms)
      ✓ a sample AWS template (sam_20161031_encryption_proxy.yaml) should validate successfully (549ms)
      ✓ a sample AWS template (sam_20161031_hello_world.yaml) should validate successfully (154ms)
      ✓ a sample AWS template (sam_20161031_implicit_api_settings.yaml) should validate successfully (443ms)
      ✓ a sample AWS template (sam_20161031_inline_swagger.yaml) should validate successfully (336ms)
      ✓ a sample AWS template (sam_20161031_iot_backend.yaml) should validate successfully (406ms)
      ✓ a sample AWS template (sam_20161031_lambda_edge.yaml) should validate successfully (176ms)
      ✓ a sample AWS template (sam_20161031_lambda_safe_deployments.yaml) should validate successfully (315ms)
      ✓ a sample AWS template (sam_20161031_s3_processor.yaml) should validate successfully (276ms)
      ✓ a sample AWS template (sam_20161031_schedule.yaml) should validate successfully (299ms)
      ✓ a sample AWS template (sam_20161031_stream_processor.yaml) should validate successfully (263ms)
      ✓ a template missing a required property should fail validation (197ms)
      ✓ a template containing an aggregate-type that has items with different types (sam_20161031_heterogenous_aggregation.yaml) should validate successfully (453ms)
      ✓ a template containing a valid SAM Globals section should validate successfully (456ms)
      ✓ a template containing an invalid SAM Globals resource type should fail validation (78ms)
      ✓ a template containing an invalid SAM Globals property name should fail validation (78ms)
      ✓ a valid real-world SAM template (sam_20161031_realworld_1.yaml) should validate successfully (489ms)
